  ...
  useEffect(() => {
    ...
    const executeFetch = async () => {
      try {
        ...
        console.log(`Current State Pension Value: ${statePensionValue}`);
        console.log(`Current State Pension Age: ${statePensionAge}`);
        const initialStatePension = response["initialStatePensionDtoReact"];
        console.log(`initialStatePensionDto: ${initialStatePension}`)
        setStatePensionAge(initialStatePension["retirementAge"]);
        setStatePensionValue(initialStatePension["retirementIncome"]);
